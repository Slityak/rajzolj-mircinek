/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: ee69fe021384517b4c125cd8bea97dd5)
// Runtime types generated with workerd@1.20260921.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	JUDGE_LIMITER: RateLimit;
	AI: Ai;
	LAB: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LAB">> {}
}
